 ...
 */
export declare function redactRecord(record: SessionTelemetryRecord, rules: Rule[]): SessionTelemetryRecord;
/**
 ...
 */
export declare function installTelemetryRedaction(ctx: Context, rules: Rule[]): void;
